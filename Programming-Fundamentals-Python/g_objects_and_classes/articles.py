class Article:
    ...
    def edit(self, new_content: str):  # changes the old content to the new one
        self.content = new_content

    def change_author(self, new_author: str):  # changes the old author with the new one
        self.author = new_author

    def rename(self, new_title: str):  # changes the old title with the new one
